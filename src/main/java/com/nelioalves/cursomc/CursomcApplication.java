...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null, "Jardnagem");
		...
		cli1.getTelefones().addAll(Arrays.asList("12345", "54321"));
		
		clienteRepository.saveAll(Arrays.asList(cli1));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "5544665", cli1, c1);	
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 803", "Centro", "5544665", cli1, c2);	
